...
Usage : python bom_mergy.py 1.bom 2.bom 3.bom output.xls
        // Include other bom which is excel file
		python bom_mergy.py 1.bom 2.bom 3.bom -inc other.xls output.xls
        // Use database excel file
		python bom_mergy.py 1.bom 2.bom 3.bom -inc other.xls -db db.xls output.xls
        // Use on key for merging, default on key is "Part"
		python bom_mergy.py 1.bom 2.bom 3.bom -inc other.xls -db db.xls output.xls -on Value
@author: Jason Lee
"""
import argparse
import numpy as np
...
def merge(dfa, outfile, onkey):
    ...
    dfm.index = range(1, len(dfm)+1)    # reset and sort index again
...
if __name__ == '__main__':
    ...
    if args.inc:
        ...
        dfinc.index = range(1, len(dfinc)+1)    # reset and sort index again
